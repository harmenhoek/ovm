...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='log',
            name='file1',
            field=models.FileField(blank=True, null=True, upload_to='', verbose_name='Bestanden'),
        ),
        migrations.AlterField(
            model_name='log',
            name='file2',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file1', models.TextField(blank=True, max_length=100, null=True, verbose_name='Bestanden')),
                ('file2', models.TextField(blank=True, max_length=100, null=True, verbose_name='')),
